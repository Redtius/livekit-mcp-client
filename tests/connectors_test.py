...
@pytest.mark.asyncio
async def test_sse_is_alive_success(
    sse_connector: SSEConnector, mock_shared_session: MagicMock
):
...
@pytest.mark.asyncio
async def test_sse_is_alive_timeout(
    sse_connector: SSEConnector, mock_shared_session: MagicMock
):
...
@pytest.mark.asyncio
async def test_sse_is_alive_connection_error(
    sse_connector: SSEConnector, mock_shared_session: MagicMock
):
...
@pytest.mark.asyncio
async def test_stdio_is_alive_success(
    stdio_connector: StdioConnector, mock_shared_session: MagicMock
):
    """Test is_alive when connection is healthy."""
...
@pytest.mark.asyncio
async def test_stdio_is_alive_timeout(
    stdio_connector: StdioConnector, mock_shared_session: MagicMock
):
...
@pytest.mark.asyncio
async def test_stdio_is_alive_connection_error(
    stdio_connector: StdioConnector, mock_shared_session: MagicMock
):
